...
public class Modificador extends ClassePersonagem {
	...
	public String getMdestrezalbl() {
		String sinal = "";

		if (Mdestreza >= 0)
			sinal = "+";

		return sinal + Mdestreza;
	}
	
	public String getMconstituicaolbl() {
		String sinal = "";

		if (Mconstituicao >= 0)
			sinal = "+";

		return sinal + Mconstituicao;
	}

	public String getMinteligencialbl() {
		String sinal = "";

		if (Minteligencia >= 0)
			sinal = "+";

		return sinal + Minteligencia;
	}
	
	public String getMsabedorialbl() {
		String sinal = "";

		if (Msabedoria >= 0)
			sinal = "+";

		return sinal + Msabedoria;
	}

	public String getMcarismalbl() {
		String sinal = "";

		if (Mcarisma >= 0)
			sinal = "+";

		return sinal + Mcarisma;
	}
	...
	public String toString() {
		return "%nFOR: " + getForca() + "%nDES: " + getDestreza() + "%nCON: " + getConstituicao() + "%nINT: "
				+ getInteligencia() + "%nSAB: " + getSabedoria() + "%nCAR: " + getCarisma();
	}
