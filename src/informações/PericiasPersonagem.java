...
public class PericiasPersonagem extends TesteDeResistencia {
	...
	public void addPericias() {
		...
		atuacao = getMcarisma();
		blefar = getMcarisma();
		furtividade = getMdestreza();
		historia = getMinteligencia();
		intimidacao = getMcarisma();
		intuicao = getMsabedoria();
		investigacao = getMinteligencia();
		lidarAnimais = getMsabedoria();
		medicina = getMsabedoria();
		natureza = getMinteligencia();
		percepcao = getMsabedoria();
		persuasao = getMcarisma();
		prestidigitacao = getMdestreza();
		religiao = getMinteligencia();
		sobrevivencia = getMsabedoria();
